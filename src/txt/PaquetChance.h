#ifndef PAQUETCHANCE_H_INCLUDED
#define PAQUETCHANCE_H_INCLUDED

/**
    @brief Ce fichier contient les en-tetes des fonctions relatives a la gestion des files des cartes chance
...
class Carte;
/**
    @class PaquetChance PaquetChance.h PaquetChance.h la classe qui permet de generer une case
*/
class PaquetChance{
public:
struct Cellule {
...
*/
    PaquetChance ();
/**
*   @brief destructeur de PaquetChance
*   @param pas d'argument
...
*/
    PaquetChance& operator = (const PaquetChance & p);
